...
class Call {
  ...
  static fromBuffer (buffer) {
    ...
    if (type !== 'call') throw new InvalidArgumentException('Buffer is not a call')
    if (mid === undefined) throw new InvalidArgumentException('Buffer does not contain a message id')
    if (name === undefined) throw new InvalidArgumentException('Buffer does not contain a method name')
    if (args === undefined) throw new InvalidArgumentException('Buffer does not contain arguments')
